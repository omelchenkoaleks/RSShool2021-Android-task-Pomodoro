package com.omelchenkoaleks.rsshool2021_android_task_pomodoro.views
...
class CustomProgressView @JvmOverloads constructor(
    ...
    init {
        if (attrs != null) {
            ...
            color = styledAttrs.getColor(R.styleable.CustomProgressView_custom_color, Color.RED)
            style = styledAttrs.getInt(R.styleable.CustomProgressView_custom_style, FILL)
            styledAttrs.recycle()
        }
